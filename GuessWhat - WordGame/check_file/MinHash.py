...
class MinHash(text_similarity.TextSemanticSimilarity):
    ...
    def evaluate_util(self,file_name=""):
        ...
        if file_name=='semEval':
            ...
            df=pd.read_csv("C://Users//malla//Downloads//sts-test.csv",error_bad_lines=False,sep='\t',usecols=range(7),engine='python')
        ...
        if file_name=='sick':
            input_df= self.read_dataset("sick.xlsx") 
        ...
        if file_name=='semEval2014':
           input_df=self.read_dataset('semEval2014.xlsx')
           for index, row in input_df.iterrows():
